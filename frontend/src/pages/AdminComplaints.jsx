...
const AdminComplaints = () => {
  ...
  const handleUpdateStatus = async () => {
    try {
      await adminAPI.updateComplaint(selectedComplaint._id, {
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
          ...
          <div className="flex flex-wrap gap-3 w-full md:w-auto">
            <Link
              to="/"
              className="flex-1 md:flex-none justify-center py-3 px-4 md:px-6 md:py-3 bg-gray-500 text-white rounded-xl font-semibold hover:bg-gray-600 transition-all flex items-center gap-2 text-sm md:text-base"
            >
            ...
            <button
              ...
              className="flex-1 md:flex-none justify-center px-4 py-3 md:px-6 md:py-3 bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 transition-all text-sm md:text-base"
            >
              View Analytics
            </button>
          </div>
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-xl p-5 mb-6 border border-gray-100"
        >
              ...
              <AnimatePresence>
                {complaints.map((complaint, index) => (
                  <motion.div
                    ...
                    className="border border-gray-200 rounded-xl p-4 sm:p-5 hover:shadow-xl transition-all bg-gradient-to-r from-white to-purple-50/30"
                  >
                    {/* MAIN FLEX */}
                    <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                      ...
                      <div className="grid grid-cols-2 md:flex md:flex-col gap-2 w-full md:w-auto">
                        <button
                          ...
                          className="w-full px-3 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all flex items-center justify-center gap-2 text-xs sm:text-sm"
                        >
                          <FaEdit /> Status
                        </button>
                        ...
                        <button
                          ...
                          className="w-full px-3 py-2 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 transition-all flex items-center justify-center gap-2 text-xs sm:text-sm"
                        >
                          <FaCheck /> Assign
                        </button>
                        ...
                        <button
                          ...
                          className="w-full px-3 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-all flex items-center justify-center gap-2 text-xs sm:text-sm"
                        >
                          <FaEdit /> Respond
                        </button>
                        ...
                        <button
                          ...
                          className="w-full px-3 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-all flex items-center justify-center gap-2 text-xs sm:text-sm"
                        >
                          <FaTrash /> Delete
                        </button>
                      </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Select a registered team member to assign this complaint
                    </p>
                  </div>
                  <div className="flex gap-4">
                    <motion.button

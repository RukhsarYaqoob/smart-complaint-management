      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="flex gap-3">
            <Link
              to="/"
              className="px-3 py-2 sm:px-6 sm:py-3 bg-gray-500 text-white rounded-xl flex items-center gap-2"
            >
              <FaHome /> Home
            </Link>
            ...
            <button
              ...
              className="px-3 py-2 sm:px-6 sm:py-3 bg-purple-600 text-white rounded-xl flex items-center gap-2"
            >
            ...
            <button
              onClick={logout}
              className="px-3 py-2 sm:px-6 sm:py-3 bg-red-500 text-white rounded-xl"
            >
              Logout
            </button>
          </div>
        ...
        {showForm && (
          <motion.div
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            className="bg-white rounded-2xl shadow-xl p-5 md:p-8 mb-8"
          >
            {error && (
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-white rounded-2xl shadow-xl p-5 md:p-8 border border-gray-100"
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="ml-auto px-3 sm:px-4 py-1.5 sm:py-2 bg-purple-100 text-purple-700 rounded-full text-xs sm:text-sm font-semibold whitespace-nowrap">
              {complaints.length}{" "}
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex-1">
                      <div className="flex items-start justify-between gap-4 mb-3">
                        ...
                        <span
                          className={`px-3 py-1 ${getStatusColor(complaint.status)} text-white rounded-full text-xs font-semibold whitespace-nowrap`}
                        >
                          {complaint.status}
                        </span>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <span
                          className={`px-3 py-1 ${getPriorityColor(complaint.priority)} text-white rounded-full text-sm font-semibold shadow-sm`}
                        >

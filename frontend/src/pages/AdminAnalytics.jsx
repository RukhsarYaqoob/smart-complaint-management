      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800 bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-3xl font-bold">
                  {overallStats.avgResolutionDays}
                </span>
              </div>
                  ...
                  >
                    ...
                    {issue.avgResolutionTime && (
                      <p className="text-sm text-gray-500 mt-2">
                        Avg Resolution: {issue.avgResolutionTime.toFixed(1)}{" "}
                        days
                      </p>
                    )}
                  </motion.div>
